...
import Badge from "../../components/Messages/NotificationBadge";
    ...
    <>
      <Layout>
        <div className="flex flex-col gap-4 bg-[#F5F5F5]">
          <p className="text-[36px] font-bold">User Notification</p>
          <div className="flex flex-row gap-4">
            <Badge />
          </div>
          <div className="bg-[white]">
            <DataGrid rows={rows} columns={columns} className="cursor-pointer" />
          </div>
        </div>
      </Layout>
    </>
