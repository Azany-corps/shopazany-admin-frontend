...
import Products from "../../components/Sellers/Store/Products/Products";
import Branches from "../../components/Sellers/Store/Branches/Branches";
          ...
          <div className="flex justify-between items-center">
            <div className="flex gap-8 items-center">
              ...
              <div className="flex gap-2 items-center text-[#1B7CFC]">
                ...
                <p>Back to Seller Profile</p>
              </div>
            </div>
            <div className="flex gap-4">
              <button className="py-2 px-4 border border-[#E51B48] text-[#E51B48] text-[14px] rounded-sm">Suspend Store</button>
              <button className="py-2 px-4 bg-[#E51B48] text-[white] text-[14px] rounded-sm">Delete Store</button>
            </div>
          </div>
